...
var _require = require('../utils/query'),
    getReferenceSchema = _require.getReferenceSchema,
...
function FiltersParser(modelSchema, timezone, options) {
  ...
  this.perform = /*#__PURE__*/function () {
    var _ref = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(filtersString) {
  ...
  this.formatAggregation = /*#__PURE__*/function () {
    var _ref2 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee2(aggregator, formatedConditions) {
  ...
  this.formatCondition = /*#__PURE__*/function () {
    var _ref4 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee3(condition) {
      var formatedField, isTextField;
      return _regenerator["default"].wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 3:
              isTextField = _this.isTextField(condition.field);
              return _context3.abrupt("return", (0, _defineProperty2["default"])({}, formatedField, _this.formatOperatorValue(condition.operator, condition.value, isTextField)));
  ...
  this.formatOperatorValue = function (operator, value) {
    var isTextField = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
    ...
    switch (operator) {
      ...
      case 'in':
        return (0, _defineProperty2["default"])({}, _this.OPERATORS.IN, value);

      case 'blank':
        return isTextField ? (0, _defineProperty2["default"])({}, _this.OPERATORS.OR, [(0, _defineProperty2["default"])({}, _this.OPERATORS.EQ, null), (0, _defineProperty2["default"])({}, _this.OPERATORS.EQ, '')]) : (0, _defineProperty2["default"])({}, _this.OPERATORS.EQ, null);
  ...
  this.isTextField = function (field) {
    if (field.includes(':')) {
      var _field$split3 = field.split(':'),
          _field$split4 = (0, _slicedToArray2["default"])(_field$split3, 2),
          associationName = _field$split4[0],
          fieldName = _field$split4[1];

      var associationSchema = getReferenceSchema(_forestExpress.Schemas.schemas, modelSchema, associationName, fieldName);
  ...
  this.getFieldTypeFromSchema = function (schema, fieldName) {
    var fieldFound = schema.fields.find(function (field) {
  ...
  this.getAssociations = /*#__PURE__*/function () {
    var _ref22 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee4(filtersString) {
